...
TTube Audio không phát video, không tải hoặc trích xuất audio từ YouTube.

## Mở dự án
1. Mở thư mục này bằng Android Studio (Ladybug hoặc mới hơn).
2. Chờ Gradle Sync tải dependencies.
3. Cài lên Android 8.0 trở lên.
4. Kết nối Android Auto; chọn **TTube Audio** trong mục Media.
